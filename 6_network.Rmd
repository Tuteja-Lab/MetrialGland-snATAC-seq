...
```{r}
dat <- data.frame(`RatPeaksWithATAC`=c(104,264-104), `RatPeaksWithoutATAC`=c(24,623))
...
```
sed 's/chr//g' ../daPeaks/gd15.5specific-TBCspecific-hg38.bed | bedtools intersect -a - -b EVTpeaks.bed -wa -u | wc -l          #11
...
```{r}
prop.test(c(264, 11), c(911, 33), p = NULL, alternative = "two.sided") #gd15.5
prop.test(c(264, 13), c(911, 124), p = NULL, alternative = "greater") #gd19.5
```
