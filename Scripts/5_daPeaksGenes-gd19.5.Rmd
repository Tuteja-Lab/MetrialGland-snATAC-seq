...
write.table(motifs19.5, "/work/LAS/geetu-lab/hhvu/project3_scATAC/scATAC-seq-analysis/5_integrating2timepoints/annotation_scRNAseq/daPeaks/allMotifs-daPeaksGD19.5coor.txt", sep = "\t", quote = F)
```
...
write.table(motifs19.5, "/work/LAS/geetu-lab/hhvu/project3_scATAC/scATAC-seq-analysis/5_integrating2timepoints/annotation_scRNAseq/daPeaks/finalMotifs-daPeaksGD19.5coor.txt", sep = "\t", quote = F)
```
...
```{r}
network <- inner_join(new19.5, motifPeaks, by = c("regions" = "peak"))
...
write.table(all, "/work/LAS/geetu-lab/hhvu/project3_scATAC/scATAC-seq-analysis/5_integrating2timepoints/annotation_scRNAseq/daPeaks/daPeaksGenes-gd19.5-exp0.txt", sep = "\t", row.names = F, quote = F)
```
