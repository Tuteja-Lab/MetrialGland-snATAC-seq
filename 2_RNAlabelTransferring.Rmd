...
load("/work/LAS/geetu-lab/hhvu/project3_scATAC/scATAC-seq-analysis/2_mergedSamples/2_MACS2Peaks/15.5_1-2-3-merged.rda")
rats <- gd15.5combined
...
load("/work/LAS/geetu-lab/hhvu/project3_scATAC/scATAC-seq-analysis/2_mergedSamples/2_MACS2Peaks/19.5_4-5-6-merged.rda")
rats <- gd19.5combined
Annotation(rats) <- rnor6.ranges
gene.activities <- GeneActivity(rats)
rats[['RNA']] <- CreateAssayObject(counts = gene.activities[, colnames(rats)])
